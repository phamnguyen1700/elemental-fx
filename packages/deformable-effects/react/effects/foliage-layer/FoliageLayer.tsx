...
import { createVineLayerEffect, type VineLayerConfig } from "../../../effects/foliage-layer";
...
export const VineLayer = forwardRef<HTMLCanvasElement, VineLayerProps>(function VineLayer(
  {
    assets,
    preset,
    quality,
